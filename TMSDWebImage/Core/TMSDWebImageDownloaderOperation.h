...
/**
 ...
 For the description about these methods, see `TMSDWebImageDownloaderOperation`
 ...
 */
@protocol TMSDWebImageDownloaderOperation <NSURLSessionTaskDelegate, NSURLSessionDataDelegate>
@required
...
// These operation-level config was inherited from downloader. See `TMSDWebImageDownloaderConfig` for documentation.
...
/**
 The download operation class for TMSDWebImageDownloader.
 */
@interface TMSDWebImageDownloaderOperation : NSOperation <TMSDWebImageDownloaderOperation>
 ...
 */
@property (assign, nonatomic, readonly) TMSDWebImageDownloaderOptions options;

/**
 * The context for the receiver.
 */
@property (copy, nonatomic, readonly, nullable) TMSDWebImageContext *context;

/**
 *  Initializes a `TMSDWebImageDownloaderOperation` object
 *
 *  @see TMSDWebImageDownloaderOperation
 *
...
- (nonnull instancetype)initWithRequest:(nullable NSURLRequest *)request
                              inSession:(nullable NSURLSession *)session
                                options:(TMSDWebImageDownloaderOptions)options
                                context:(nullable TMSDWebImageContext *)context NS_DESIGNATED_INITIALIZER;
