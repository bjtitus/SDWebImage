...
/**
 ...
 Coders
 ------
 A coder must conform to the `TMSDImageCoder` protocol or even to `TMSDProgressiveImageCoder` if it supports progressive decoding
 ...
 */
@interface TMSDImageCodersManager : NSObject <TMSDImageCoder>

/**
 Returns the global shared coders manager instance.
 */
@property (nonatomic, class, readonly, nonnull) TMSDImageCodersManager *sharedManager;
 ...
 */
@property (nonatomic, copy, nullable) NSArray<id<TMSDImageCoder>> *coders;
