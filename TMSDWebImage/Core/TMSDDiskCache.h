...
/**
 A protocol to allow custom disk cache used in TMSDImageCache.
 */
@protocol TMSDDiskCache <NSObject>
 ...
 */
@interface TMSDDiskCache : NSObject <TMSDDiskCache>
/**
 Cache Config object - storing all kind of settings.
 */
@property (nonatomic, strong, readonly, nonnull) TMSDImageCacheConfig *config;
