 ...
 */
@interface TMSDImageIOAnimatedCoder : NSObject <TMSDProgressiveImageCoder, TMSDAnimatedImageCoder>

#pragma mark - Subclass Override
/**
 The supported animated image format. Such as `TMSDImageFormatGIF`.
 @note Subclass override.
 */
@property (class, readonly) TMSDImageFormat imageFormat;
/**
 The supported image format UTI Type. Such as `kSDUTTypeGIF`.
 This can be used for cases when we can not detect `TMSDImageFormat. Such as progressive decoding's hint format `kCGImageSourceTypeIdentifierHint`.
 @note Subclass override.
 */
