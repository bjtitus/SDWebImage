...
/**
 * Integrates TMSDWebImage async downloading and caching of remote images with UIImageView for highlighted state.
 */
@interface UIImageView (TMSDHighlightedWebCache)
 ...
 */
- (void)tmsd_setHighlightedImageWithURL:(nullable NSURL *)url NS_REFINED_FOR_SWIFT;
