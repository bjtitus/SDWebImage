...
/**
 This class is used for creating animated images via `animatedImageWithFrames` in `TMSDImageCoderHelper`.
 @note If you need to specify animated images loop count, use `tmsd_imageLoopCount` property in `UIImage+Metadata.h`.
 */
@interface TMSDImageFrame : NSObject
