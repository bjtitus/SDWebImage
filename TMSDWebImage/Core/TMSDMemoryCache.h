...
@class TMSDImageCacheConfig;
/**
 A protocol to allow custom memory cache used in TMSDImageCache.
 */
@protocol TMSDMemoryCache <NSObject>
 ...
 */
@interface TMSDMemoryCache <KeyType, ObjectType> : NSCache <KeyType, ObjectType> <TMSDMemoryCache>

@property (nonatomic, strong, nonnull, readonly) TMSDImageCacheConfig *config;
