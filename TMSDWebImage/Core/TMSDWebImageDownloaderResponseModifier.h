...
typedef NSURLResponse * _Nullable (^TMSDWebImageDownloaderResponseModifierBlock)(NSURLResponse * _Nonnull response);
 ...
 */
@protocol TMSDWebImageDownloaderResponseModifier <NSObject>
...
/// @note If nil is returned, the image download will marked as cancelled with error `TMSDWebImageErrorInvalidDownloadResponse`
 ...
 */
@interface TMSDWebImageDownloaderResponseModifier : NSObject <TMSDWebImageDownloaderResponseModifier>

/// Create the response modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull TMSDWebImageDownloaderResponseModifierBlock)block;

/// Create the response modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)responseModifierWithBlock:(nonnull TMSDWebImageDownloaderResponseModifierBlock)block;
...
*/
@interface TMSDWebImageDownloaderResponseModifier (TMSDConveniences)
