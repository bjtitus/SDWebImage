...
/**
 ...
 @note If you need to support lower firmware version for WebP, you can have a try at https://github.com/TMSDWebImage/TMSDWebImageWebPCoder
 */
API_AVAILABLE(ios(14.0), tvos(14.0), macos(11.0), watchos(7.0))
@interface TMSDImageAWebPCoder : TMSDImageIOAnimatedCoder <TMSDProgressiveImageCoder, TMSDAnimatedImageCoder>

@property (nonatomic, class, readonly, nonnull) TMSDImageAWebPCoder *sharedCoder;
