 ...
 */
@protocol TMSDWebImageIndicator <NSObject>
 ...
 */
@interface TMSDWebImageActivityIndicator : NSObject <TMSDWebImageIndicator>
 ...
 */
@interface TMSDWebImageActivityIndicator (TMSDConveniences)

/// These indicator use the fixed color without dark mode support
/// gray-style activity indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageActivityIndicator *grayIndicator;
/// large gray-style activity indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageActivityIndicator *grayLargeIndicator;
/// white-style activity indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageActivityIndicator *whiteIndicator;
/// large white-style activity indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageActivityIndicator *whiteLargeIndicator;
/// These indicator use the system style, supports dark mode if available (iOS 13+/macOS 10.14+)
/// large activity indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageActivityIndicator *largeIndicator;
/// medium activity indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageActivityIndicator *mediumIndicator;
 ...
 */
@interface TMSDWebImageProgressIndicator : NSObject <TMSDWebImageIndicator>
 ...
 */
@interface TMSDWebImageProgressIndicator (TMSDConveniences)

/// default-style progress indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageProgressIndicator *defaultIndicator;
/// bar-style progress indicator
@property (nonatomic, class, nonnull, readonly) TMSDWebImageProgressIndicator *barIndicator API_UNAVAILABLE(macos, tvos);
