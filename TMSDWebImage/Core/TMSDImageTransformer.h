 ...
 */
FOUNDATION_EXPORT NSString * _Nullable TMSDTransformedKeyForKey(NSString * _Nullable key, NSString * _Nonnull transformerKey);
...
/**
 ...
 @note If you have both transformer and thumbnail applied for image, call `TMSDThumbnailedKeyForKey` firstly and then with `TMSDTransformedKeyForKey`.`
 */
FOUNDATION_EXPORT NSString * _Nullable TMSDThumbnailedKeyForKey(NSString * _Nullable key, CGSize thumbnailPixelSize, BOOL preserveAspectRatio);

/**
 A transformer protocol to transform the image load from cache or from download.
 You can provide transformer to cache and manager (Through the `transformer` property or context option `TMSDWebImageContextImageTransformer`).
 
 @note The transform process is called from a global queue in order to not to block the main queue.
 */
@protocol TMSDImageTransformer <NSObject>
 ...
 */
@interface TMSDImagePipelineTransformer : NSObject <TMSDImageTransformer>

/**
 All transformers in pipeline
 */
@property (nonatomic, copy, readonly, nonnull) NSArray<id<TMSDImageTransformer>> *transformers;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithTransformers:(nonnull NSArray<id<TMSDImageTransformer>> *)transformers;
 ...
 */
@interface TMSDImageRoundCornerTransformer: NSObject <TMSDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) TMSDRectCorner corners;
...
- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithRadius:(CGFloat)cornerRadius corners:(TMSDRectCorner)corners borderWidth:(CGFloat)borderWidth borderColor:(nullable UIColor *)borderColor;
 ...
 */
@interface TMSDImageResizingTransformer : NSObject <TMSDImageTransformer>
 ...
 */
@property (nonatomic, assign, readonly) TMSDImageScaleMode scaleMode;

- (nonnull instancetype)init NS_UNAVAILABLE;
+ (nonnull instancetype)transformerWithSize:(CGSize)size scaleMode:(TMSDImageScaleMode)scaleMode;
 ...
 */
@interface TMSDImageCroppingTransformer : NSObject <TMSDImageTransformer>
 ...
 */
@interface TMSDImageFlippingTransformer : NSObject <TMSDImageTransformer>
 ...
 */
@interface TMSDImageRotationTransformer : NSObject <TMSDImageTransformer>
 ...
 */
@interface TMSDImageTintTransformer : NSObject <TMSDImageTransformer>
 ...
 */
@interface TMSDImageBlurTransformer : NSObject <TMSDImageTransformer>
 ...
 */
@interface TMSDImageFilterTransformer: NSObject <TMSDImageTransformer>
