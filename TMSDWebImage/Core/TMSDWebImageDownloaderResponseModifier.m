...
@interface TMSDWebImageDownloaderResponseModifier ()

@property (nonatomic, copy, nonnull) TMSDWebImageDownloaderResponseModifierBlock block;

@end

@implementation TMSDWebImageDownloaderResponseModifier

- (instancetype)initWithBlock:(TMSDWebImageDownloaderResponseModifierBlock)block {
    self = [super init];
    if (self) {
        self.block = block;
    }
...
+ (instancetype)responseModifierWithBlock:(TMSDWebImageDownloaderResponseModifierBlock)block {
    TMSDWebImageDownloaderResponseModifier *responseModifier = [[TMSDWebImageDownloaderResponseModifier alloc] initWithBlock:block];
...
@implementation TMSDWebImageDownloaderResponseModifier (TMSDConveniences)
