...
/**
 ...
 For a full GIF support, we recommend `TMSDAnimatedImageView` to keep both CPU and memory balanced.
 ...
 */
@interface TMSDImageIOCoder : NSObject <TMSDProgressiveImageCoder>

@property (nonatomic, class, readonly, nonnull) TMSDImageIOCoder *sharedCoder;
