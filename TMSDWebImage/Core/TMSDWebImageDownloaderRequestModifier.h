...
typedef NSURLRequest * _Nullable (^TMSDWebImageDownloaderRequestModifierBlock)(NSURLRequest * _Nonnull request);
 ...
 */
@protocol TMSDWebImageDownloaderRequestModifier <NSObject>
 ...
 */
@interface TMSDWebImageDownloaderRequestModifier : NSObject <TMSDWebImageDownloaderRequestModifier>

/// Create the request modifier with block
/// @param block A block to control modifier logic
- (nonnull instancetype)initWithBlock:(nonnull TMSDWebImageDownloaderRequestModifierBlock)block;

/// Create the request modifier with block
/// @param block A block to control modifier logic
+ (nonnull instancetype)requestModifierWithBlock:(nonnull TMSDWebImageDownloaderRequestModifierBlock)block;
...
*/
@interface TMSDWebImageDownloaderRequestModifier (TMSDConveniences)
