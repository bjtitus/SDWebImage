 ...
 */
@interface UIImage (TMSDMultiFormat)
#pragma mark - Decode
/**
...
/**
 ...
 @note If the receiver is `TMSDAnimatedImage`, this will return the animated image data if available. No more extra encoding process.
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)tmsd_imageDataAsFormat:(TMSDImageFormat)imageFormat NS_SWIFT_NAME(tmsd_imageData(as:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)tmsd_imageDataAsFormat:(TMSDImageFormat)imageFormat compressionQuality:(double)compressionQuality NS_SWIFT_NAME(tmsd_imageData(as:compressionQuality:));
...
/**
 ...
 @return The encoded data. If can't encode, return nil
 */
- (nullable NSData *)tmsd_imageDataAsFormat:(TMSDImageFormat)imageFormat compressionQuality:(double)compressionQuality firstFrameOnly:(BOOL)firstFrameOnly NS_SWIFT_NAME(tmsd_imageData(as:compressionQuality:firstFrameOnly:));
